...
$(document).ready( function () {
  ...
  $(document).ready( function () {
		$('#query button').click( function (e) {
			...
			$.ajax({
			    type: "POST",
			    url: "http://10.10.226.79/query.php",
...
<body>
  <div id="chat" class="col-sm-4">
    <div id="chat-circle">
      ...
      <img src="assests/image/icon.jpg" style="border-radius: 50%;
      width: 100%;" alt="chat">
    </div>
    <div class="chat-box" style="display: none;">
      <div class="chat-box-header">KPR-ChatBot<span class="chat-box-toggle"> <i class="material-icons">close</i> </span>
      </div>
      <div class="chat-box-body">
        ...
        <?php if(!isset($_SESSION['s_email'])){?>
          <form id='usr-details' autocomplete="off" name="usr-details"  >
            <div id="cm-msg-0" class="chat-msg user" >
               <span class="msg-avatar"> <img src="assests/image/icon.jpg">
              </span>
              <br><br>
              ...
              <div>
                 ...
                 <center>  <button type="submit" id='gen' name='gen' value='General Inquiry'>Proceed To Chat</button> </center>
                 </div>
        ...
        <?php }else { ?>
          ...
          <div id="cm-msg-0" class="chat-msg user">
          <span class="msg-avatar"> <img src="assests/image/icon.jpg"> </span>
          <div class="cm-msg-text">Hello I'm KPR Chat-Bot (beta)</div>
        </div>
       ...
       <?php }?>  
        ...
        <div id="cm-msg-0" class="chat-msg user hidden1">
          <form id='query'>
            <label class="hidden1">Enter your query </label>
 ...
 <?php if(!isset($_SESSION['s_email'])){?> 
  <div class="chat-input hidden ">
      <form autocomplete="off">
          ...
          <img onclick="startDictation()" class="chat-mic" src="assests/image/mic.gif" />    
